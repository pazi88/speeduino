...
byte pinTPS2; //pin for second TPS sensor
byte pinPedal; //pin for the pedal sensor
byte pinPedal2; //pin for the second pedal sensor
byte pinDBWdir; //H-bridge direction output for the DBW
byte pinDBWdir2; //Inverted H-bridge direction output for the DBW
