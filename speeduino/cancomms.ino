...
void sendGaugeMessage(uint16_t gaugeMessageID)
{
  switch (gaugeMessageID)
  {
    case 0x316:       //RPM for BMW e46/e39/e38 instrument cluster
      uint16_t temp_RPM;
    ...
    case 0x329:       //CLT and TPS for BMW e46/e39/e38 instrument cluster
      uint8_t temp_TPS;
      int16_t temp_CLT;
