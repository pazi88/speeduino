  ...
  switch (boardID)
  {
   ...
   case 31:
    ...
    case 41:
      ...
      pinInjector5 = 42; //Output pin injector 5 is on
      pinInjector6 = 45; //Output pin injector 6 is on
      pinInjector7 = 47; //Output pin injector 7 is on
      pinInjector8 = 49; //Output pin injector 8 is on
      pinCoil1 = 35; //Pin for coil 1
      pinCoil2 = 36; //Pin for coil 2
      pinCoil3 = 33; //Pin for coil 3
      pinCoil4 = 34; //Pin for coil 4
      pinCoil5 = 38; //Pin for coil 5
      pinCoil6 = 39; //Pin for coil 6
      pinCoil7 = 40; //Pin for coil 7
      pinCoil8 = 41; //Pin for coil 8
      pinTrigger = 19; //The CAS pin
      pinTrigger2 = 18; //The Cam Sensor pin
      pinTrigger3 = 3; //The Cam sensor 2 pin
