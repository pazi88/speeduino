...
void setPinMapping(byte boardID)
{
  ...
  switch (boardID)
  {
   ...
   case 31:
      ...
      pinCoil5 = 38; //Pin for coil 2
      //pinCoil6 = 34; //Pin for coil 6
      pinCoil6 = 48; //Pin for coil 2
      ...
      pinInjector4 = PE7; //Output pin injector 2
      //pinInjector5 = PA8; //Output pin injector 5
      pinInjector5 = PB14; //Output pin injector 2
      //pinInjector6 = PE7; //Output pin injector 6
      pinInjector6 = PB13; //Output pin injector 2
      ...
      pinCoil5 = PE3; //Pin for coil 2
      //pinCoil6 = PE5; //Pin for coil 6
      pinCoil6 = PE6; //Pin for coil 2
