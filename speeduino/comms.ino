...
void updateFullStatus()
{
  ...
  fullStatus[32] = currentStatus.spark; //Spark related bitfield
  ...
  fullStatus[39] = currentStatus.testOutputs;
  ...
  fullStatus[74] = lowByte(currentStatus.tpsADC);
  fullStatus[75] = highByte(currentStatus.tpsADC);
  fullStatus[76] = getNextError();

  fullStatus[77] = lowByte(currentStatus.PW1); //Pulsewidth 1 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[78] = highByte(currentStatus.PW1); //Pulsewidth 1 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[79] = lowByte(currentStatus.PW2); //Pulsewidth 2 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[80] = highByte(currentStatus.PW2); //Pulsewidth 2 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[81] = lowByte(currentStatus.PW3); //Pulsewidth 3 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[82] = highByte(currentStatus.PW3); //Pulsewidth 3 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[83] = lowByte(currentStatus.PW4); //Pulsewidth 4 multiplied by 10 in ms. Have to convert from uS to mS.
  fullStatus[84] = highByte(currentStatus.PW4); //Pulsewidth 4 multiplied by 10 in ms. Have to convert from uS to mS.

  fullStatus[85] = currentStatus.status3;
  fullStatus[86] = currentStatus.engineProtectStatus;
  fullStatus[87] = lowByte(currentStatus.fuelLoad);
  fullStatus[88] = highByte(currentStatus.fuelLoad);
  fullStatus[89] = lowByte(currentStatus.ignLoad);
  fullStatus[90] = highByte(currentStatus.ignLoad);
  fullStatus[91] = lowByte(currentStatus.dwell);
  fullStatus[92] = highByte(currentStatus.dwell);
  fullStatus[93] = currentStatus.CLIdleTarget;
  fullStatus[94] = currentStatus.mapDOT;
  fullStatus[95] = (int8_t)currentStatus.vvt1Angle;
  ...
  fullStatus[101] = currentStatus.VE; //Current VE (%). Can be equal to VE1 or VE2 or a calculated value from both of them
  fullStatus[102] = currentStatus.ASEValue; //Current ASE (%)
  fullStatus[103] = lowByte(currentStatus.vss);
  fullStatus[104] = highByte(currentStatus.vss);
  fullStatus[105] = currentStatus.gear;
  fullStatus[106] = currentStatus.fuelPressure;
  fullStatus[107] = currentStatus.oilPressure;
  fullStatus[108] = currentStatus.wmiPW;
  fullStatus[109] = currentStatus.wmiEmpty;
  fullStatus[110] = (int8_t)currentStatus.vvt2Angle;
